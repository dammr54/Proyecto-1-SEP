...
HD_PWD='C:/Users/Diego/Desktop/Proyecto-1-SEP/proyecto/proyecto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ParpadeoMorse.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ParpadeoMorse.tcl -notrace
