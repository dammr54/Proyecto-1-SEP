...
HD_PWD='C:/Users/Diego/Desktop/Proyecto-1-SEP/conectar_proyecto/conectar_proyecto.runs/design_1_sistema_morse_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sistema_morse_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sistema_morse_0_0.tcl
