...
-- Date        : Fri Oct 11 22:09:12 2024
-- Host        : DESKTOP-3GDKKRS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Diego/Desktop/Proyecto-1-SEP/conectar_proyecto/conectar_proyecto.srcs/sources_1/bd/design_1/ip/design_1_ControlUnit_0_0/design_1_ControlUnit_0_0_sim_netlist.vhdl
...
entity design_1_ControlUnit_0_0_ControlUnit is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ControlUnit_0_0_ControlUnit : entity is "ControlUnit";
end design_1_ControlUnit_0_0_ControlUnit;

architecture STRUCTURE of design_1_ControlUnit_0_0_ControlUnit is
  ...
  attribute SOFT_HLUTNM of \estado[0]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \estado[1]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \estado[2]_INST_0\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of ram_enable_INST_0 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of selec_enable_INST_0 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of write_in_INST_0 : label is "soft_lutpair5";
begin
  Q(0) <= \^q\(0);
...
\estado[0]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\estado[1]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\estado[2]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
entity design_1_ControlUnit_0_0 is
  ...
  attribute ip_definition_source of design_1_ControlUnit_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_ControlUnit_0_0 : entity is "ControlUnit,Vivado 2020.1";
...
begin
U0: entity work.design_1_ControlUnit_0_0_ControlUnit
     port map (
      D(4) => boton1,
