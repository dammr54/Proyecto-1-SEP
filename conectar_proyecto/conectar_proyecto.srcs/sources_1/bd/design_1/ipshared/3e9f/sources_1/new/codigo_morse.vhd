...
-- este componente por medio de codigo combinacional asigna la seleccion de los switches a un simbolo de codigo morse y define su mascara
...
begin
    process(seleccion, enable, rst)
    -- uso de variables
    variable ult_morse : STD_LOGIC_VECTOR(4 downto 0) := "00000"; -- almacenar el código Morse
    variable ult_mascara : STD_LOGIC_VECTOR(4 downto 0) := "00000"; -- almacenar máscara de código morse
    begin
        if rst = '1' then
            flag <= '0';
            morse <= (others => '0');
