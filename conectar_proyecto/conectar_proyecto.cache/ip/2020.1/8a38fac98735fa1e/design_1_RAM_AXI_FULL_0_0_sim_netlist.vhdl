...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM_AXI_FULL_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \BRAM_GEN[0].BYTE_BRAM_GEN[0].reg_in[0][9]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \s00_axi_rdata[0]_INST_0\ : label is "soft_lutpair13";
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].reg_in[0][9]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].reg_in[0][9]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
RAM_AXI_FULL_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM_AXI_FULL_v1_0_S00_AXI
     port map (
      ...
      test(9 downto 0) => test(9 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
