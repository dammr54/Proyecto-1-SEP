...
/* synthesis syn_black_box black_box_pad_pin="clk,probe_in0[5:0],probe_in1[0:0],probe_in2[0:0],probe_in3[4:0],probe_in4[4:0],probe_in5[3:0],probe_in6[0:0],probe_in7[0:0]" */;
  input clk;
  input [5:0]probe_in0;
  input [0:0]probe_in1;
  input [0:0]probe_in2;
